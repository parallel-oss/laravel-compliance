...
Vanta raw resources live under `resources/frameworks/vanta/raw`. Generated, package-runtime data lives under `resources/frameworks/vanta/data`.

- `frameworks.php`: framework catalog rows.
- `framework-controls.php`: framework requirement sections from raw Vanta framework files.
- `internal-controls.php`: curated engineering-relevant Vanta controls used by code evidence.
- `tests.php`: curated engineering-relevant Vanta monitoring tests.
...
GDPR framework references come from Vanta raw framework sections and generated framework-control/internal-control pivots. They are not legal advice and do not prove legal compliance.

## SOC 2

SOC 2 mappings reference AICPA Trust Services Criteria sections through generated Vanta framework-control rows. They are section-level references because SOC 2 evidence usually combines code, policies, tickets, logs, approvals, monitoring, and audit samples.
